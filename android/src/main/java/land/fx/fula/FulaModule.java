  ...
  private byte[] createPeerIdentity(byte[] privateKey) throws Exception {
    try {
      ...
      if (encryptedKey == null) {
        ...
        //encryptedKey = Cryptography.encryptMsg(toString(autoGeneratedIdentity), secretKey);
        encryptedKey = toString(autoGeneratedIdentity);
        sharedPref.add(PRIVATE_KEY_STORE_ID, encryptedKey);
      }
      //return toByte(Cryptography.decryptMsg(encryptedKey, secretKey));
      return toByte(encryptedKey);
